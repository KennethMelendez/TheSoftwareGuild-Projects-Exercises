 ...
 */
package com.mycompany.rpsrefactor;
...
//            }
            ...
            //Da Rules!
            if(playerChoiceStringOutput.equalsIgnoreCase("rock") && rivalsChoice.equalsIgnoreCase("rock") || playerChoiceStringOutput.equalsIgnoreCase("paper") && rivalsChoice.equalsIgnoreCase("paper") || playerChoiceStringOutput.equalsIgnoreCase("scissors") && rivalsChoice.equalsIgnoreCase("scissors")){
                System.out.println("It's a tie!!!");
                ties+=1;
                numberOfRoundsPassed+=1;
            } else if (playerChoiceStringOutput.equalsIgnoreCase("rock") && rivalsChoice.equalsIgnoreCase("paper") || playerChoiceStringOutput.equalsIgnoreCase("scissors") && rivalsChoice.equalsIgnoreCase("rock") || playerChoiceStringOutput.equalsIgnoreCase("paper") && rivalsChoice.equalsIgnoreCase("scissors")){
                System.out.println("You lose!");
                loses+=1;
                numberOfRoundsPassed+=1;
            } else if (playerChoiceStringOutput.equalsIgnoreCase("rock") && rivalsChoice.equalsIgnoreCase("scissors") || playerChoiceStringOutput.equalsIgnoreCase("scissors") && rivalsChoice.equalsIgnoreCase("paper") || playerChoiceStringOutput.equalsIgnoreCase("paper") && rivalsChoice.equalsIgnoreCase("rock")){
         ...
         //Calls the function in order to output the result
         ScoreBoard(numberOfRoundsPassed, wins, loses, ties);
...
//            }
        ...
        public static void ScoreBoard(int numberOfRoundsPassed, int wins, int loses, int ties){
        //outputs the results for the user
