...
public class Maths {
    public static void main(String[] args) {
        ...
        System.out.print("5560 divided by 22.0 is : ");
        ...
        System.out.println(" 4 * 5 = " + 4 * 5 + " yes");
