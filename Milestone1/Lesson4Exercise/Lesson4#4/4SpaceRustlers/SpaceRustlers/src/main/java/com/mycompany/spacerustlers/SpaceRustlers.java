...
public class SpaceRustlers {
    public static void main (String[] args){
        ...
        The else if and if statements create logic and steps for the program based on the perameters given.        
        Removing the else from if else makes each code block break after each if statment.
